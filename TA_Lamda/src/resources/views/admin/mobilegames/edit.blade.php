...
<div class="card border-0 text-white mt-3">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.mobilegames.update", [$mobilegame->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="gamename">{{ trans('cruds.mobilegame.fields.gamename') }}</label>
                <input class="form-control {{ $errors->has('gamename') ? 'is-invalid' : '' }}" type="text" name="gamename" id="gamename" value="{{ old('gamename', $mobilegame->gamename) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('developer') ? 'is-invalid' : '' }}" type="text" name="developer" id="developer" value="{{ old('developer', $mobilegame->developer) }}" required>
            ...
            <div class="form-group">
                ...
                <textarea cols="50" rows="10" class="form-control {{ $errors->has('about') ? 'is-invalid' : '' }}" type="text" name="about" id="about" value="{{ old('about', $mobilegame->about) }}" required>{{ old('about', $mobilegame->about) }}</textarea>
                @if($errors->has('about'))
                    <div class="invalid-feedback">
                        {{ $errors->first('about') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('genre') ? 'is-invalid' : '' }}" type="text" name="genre" id="genre" value="{{ old('genre', $mobilegame->genre) }}" required>
                @if($errors->has('genre'))
                    <div class="invalid-feedback">
                        {{ $errors->first('genre') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('publish_date') ? 'is-invalid' : '' }}" type="text" name="publish_date" id="publish_date" value="{{ old('publish_date', $mobilegame->publish_date) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('download_url') ? 'is-invalid' : '' }}" type="text" name="download_url" id="download_url" value="{{ old('download_url', $mobilegame->download_url) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('thumbnail_url') ? 'is-invalid' : '' }}" type="text" name="thumbnail_url" id="thumbnail_url" value="{{ old('thumbnail_url', $mobilegame->thumbnail_url) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('screenshot_url_1') ? 'is-invalid' : '' }}" type="text" name="screenshot_url_1" id="screenshot_url_1" value="{{ old('screenshot_url_1', $mobilegame->screenshot_url_1) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('screenshot_url_2') ? 'is-invalid' : '' }}" type="text" name="screenshot_url_2" id="screenshot_url_2" value="{{ old('screenshot_url_2', $mobilegame->screenshot_url_2) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('screenshot_url_3') ? 'is-invalid' : '' }}" type="text" name="screenshot_url_3" id="screenshot_url_3" value="{{ old('screenshot_url_3', $mobilegame->screenshot_url_3) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('screenshot_url_4') ? 'is-invalid' : '' }}" type="text" name="screenshot_url_4" id="screenshot_url_4" value="{{ old('screenshot_url_4', $mobilegame->screenshot_url_4) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('video_url') ? 'is-invalid' : '' }}" type="text" name="video_url" id="video_url" value="{{ old('video_url', $mobilegame->video_url) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('postedby') ? 'is-invalid' : '' }}" type="text" name="postedby" id="postedby" value="{{ old('postedby', $mobilegame->postedby) }}" readonly>
