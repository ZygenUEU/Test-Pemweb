    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.games.update", [$game->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('gamename') ? 'is-invalid' : '' }}" type="text" name="gamename" id="gamename" value="{{ old('gamename', $game->gamename) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('developer') ? 'is-invalid' : '' }}" type="text" name="developer" id="developer" value="{{ old('developer', $game->developer) }}" required>
