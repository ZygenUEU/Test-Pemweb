...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.anime.title_singular') }}
    </div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.animes.update", [$anime->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('animename') ? 'is-invalid' : '' }}" type="text" name="animename" id="animename" value="{{ old('animename', $anime->animename) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('studio') ? 'is-invalid' : '' }}" type="text" name="studio" id="studio" value="{{ old('studio', $anime->studio) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('episode') ? 'is-invalid' : '' }}" type="text" name="episode" id="episode" value="{{ old('episode', $anime->episode) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('aired') ? 'is-invalid' : '' }}" type="text" name="aired" id="aired" value="{{ old('aired', $anime->aired) }}" required>
                @if($errors->has('aired'))
                    <div class="invalid-feedback">
                        {{ $errors->first('aired') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('duration') ? 'is-invalid' : '' }}" type="text" name="duration" id="duration" value="{{ old('duration', $anime->duration) }}" required>
