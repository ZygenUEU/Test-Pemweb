    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.foods.update", [$food->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('product') ? 'is-invalid' : '' }}" type="text" name="product" id="product" value="{{ old('product', $food->product) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('expired') ? 'is-invalid' : '' }}" type="text" name="expired" id="expired" value="{{ old('expired', $food->expired) }}" required>
