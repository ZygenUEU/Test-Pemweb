<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @endcan
        @can('sample_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/films*") ? "c-show" : "" }}">
                <a class="c-sidebar-nav-dropdown-toggle" href="#">
                ...
                <ul class="c-sidebar-nav-dropdown-items">
                    ...
                    @can('film_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.films.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/films") || request()->is("admin/films/*") ? "c-active" : "" }}">
                                <i class="fa-fw fas fa-book c-sidebar-nav-icon">

                                </i>
                                {{ trans('cruds.film.title') }}
                            </a>
                        </li>
                    @endcan
                    @can('anime_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.animes.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/animes") || request()->is("admin/animes/*") ? "c-active" : "" }}">
                                <i class="fa-fw fas fa-book c-sidebar-nav-icon">

                                </i>
                                {{ trans('cruds.anime.title') }}
                            </a>
                        </li>
                    @endcan
                </ul>
