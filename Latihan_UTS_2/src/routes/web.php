...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => ['auth']], function () {
    ...
    // Film
    Route::delete('films/destroy', 'FilmController@massDestroy')->name('films.massDestroy');
    Route::resource('films', 'FilmController');

    // Anime
    Route::delete('animes/destroy', 'AnimeController@massDestroy')->name('animes.massDestroy');
